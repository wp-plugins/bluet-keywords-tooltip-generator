...
?>
	<div>
		...
		<input type="checkbox" id="bluet_kw_admin_exclude_post_from_matching_id" onClick="hideIfChecked()" name="bluet_exclude_post_from_matching_name" <?php if($exclude_me) echo "checked"; ?>/><span style="color:red;"><?php _e('Exclude this post','bluet-kw'); ?></span>

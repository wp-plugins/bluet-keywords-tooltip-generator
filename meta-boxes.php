...
function bluet_keyword_settings_render(){
	?>
	<p>
	<Label><?php _e('Synonyms','bluet-kw');?></label><input id="bluet_synonyms_name" name="bluet_synonyms_name" type="text" value="<?php echo(get_post_meta(get_the_id(),'bluet_synonyms_keywords',true));?>" placeholder="<?php _e("Type here the keyword's Synonyms separated with '|'","bluet-kw");?>" style=" width:100%;" />
	</p>
	<?php

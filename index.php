										...
										if(portion.text!="" && portion.text!=" " && portion.text!="\t" && portion.text!="\n" ){
											...
											?>
													...
													if(suffix!=""){
														...
														elem.innerHTML=before_kw+" "+txt_to_display+after_kw.match(reg)+"<img src='<?php echo(plugins_url('/assets/qst-mark-1.png',__FILE__)); ?>' class='bluet_tooltip' data-tooltip="+tooltipIds[i]+" />"+suff_after_kw;
													}else{
														elem.innerHTML=before_kw+" "+txt_to_display+"<img src='<?php echo(plugins_url('/assets/qst-mark-1.png',__FILE__)); ?>' class='bluet_tooltip' data-tooltip="+tooltipIds[i]+" />"+after_kw;
													}
													return elem;

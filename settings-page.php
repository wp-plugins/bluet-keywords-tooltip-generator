...
/* enqueue angularJS  for test only*/
		...
		<div id="bluet-general" class="wrap" ng-app="myModule" ng-init="tabul='style'; descbgcol='#fff145'">
			...
			<?php settings_errors();?>				
				<h2 class="nav-tab-wrapper">
					...
					<a class="nav-tab" ng-click="tabul = 'excluded'" ng-class="{'nav-tab-active': tabul == 'excluded'}"><?php _e('Excluded posts','bluet-kw');?></a>
					<a class="nav-tab" href="https://wordpress.org/support/plugin/bluet-keywords-tooltip-generator" ><?php _e('Help !','bluet-kw');?></a>
			...
			<?php
				...
				echo('<div class="bluet-section" id="bluet-section-excluded" ng-show="tabul===\'excluded\'">');
				?>				
